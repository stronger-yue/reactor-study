...
import com.ttpai.study.netty.reactor1.BasicHandler;
...
public class MultiReactor {
	public static void main(String[] args) throws IOException {
		MultiReactor mr = new MultiReactor(8080);
		mr.start();
	}
	...
	class Acceptor implements Runnable {
		...
		public synchronized void run() {
			try {
				...
				if (sc != null) {
					// 把提示发到界面
					sc.write(ByteBuffer.wrap("Implementation of Reactor Design Partten \r\nreactor> ".getBytes()));
